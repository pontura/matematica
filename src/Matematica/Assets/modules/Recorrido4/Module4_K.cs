...
public class Module4_K : ModuleData {
	...
	void SetResults(List<string> data)
	{
        ...
        SetValue("-0," + value_a + value_b + value_c+ "@PeriodicABC");
        SetValue("-0," + value_a + value_b + value_c + "@PeriodicC");
        SetValue("-0," + value_a + value_b + value_c + "@PeriodicBC");
    }
